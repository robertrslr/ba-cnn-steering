...
\note{GRUNDSATZ: , Chollet depp learning zitieren}
...
\note{Hervorhaben, welche Teile des DroNet Codes ich weiterverwede. Hard Mining, Auswertungsfunktionen, Adam, learning rsate decay, KEINE shifts}
