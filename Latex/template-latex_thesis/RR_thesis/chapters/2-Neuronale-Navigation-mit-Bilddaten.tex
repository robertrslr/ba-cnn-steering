...
Der Residual-Ansatz fügt einem normalen Block gewichteter Layer eine Abkürzung hinzu, auf das normale Mapping H(x) für den Input x wird zusätzlich der Input selbst addiert
